...
## Done when
- [x] About name/bio defaults appear when editing Site Settings
- [x] Resume rich-text field is prefilled or clearly documents the bundled fallback
- [x] No blank surprise on first CMS open for those groups
