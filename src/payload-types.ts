...
/**
 * Long-form articles for custardsquare.exe
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface Article {
  ...
  title: string;
  /**
   * URL path: /articles/your-slug
   */
  slug: string;
  /**
   * Short summary shown on the article list
   */
  excerpt: string;
  content: {
    root: {
...
export interface Project {
  ...
  title: string;
  /**
   * Public URL. Visit site in the Projects window opens this.
   */
  url: string;
  /**
   * One-line blurb in the Projects window status bar
   */
  summary: string;
  /**
   * Longer story in the Projects window. Blank line between paragraphs.
   */
  story?: string | null;
  /**
  ...
  /**
   * Uncheck to hide from the public Projects window
   */
...
/**
 * Site-wide title, images, links, and credits. Only you edit this.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface SiteSetting {
  id: number;
  /**
   * Browser tab title and site name
   */
  siteTitle: string;
  /**
  ...
  /**
   * Fallback social share image when a page has no OG image
   */
  defaultOgImage?: (number | null) | Media;
  /**
   * Browser tab icon — square PNG recommended
   */
  favicon?: (number | null) | Media;
  /**
   * Links shown on the homepage (GitHub, etc.)
   */
  socialLinks?:
    | {
        label: string;
